...
public class TravellerLocationSearchAdapter extends ParseQueryAdapter{

    public TravellerLocationSearchAdapter(Context context, final String locationToSearch)
    {
        super(context, new QueryFactory<ParseUser>() {
            public ParseQuery create() {
                ParseQuery<ParseUser> query = ParseUser.getQuery();
                query.whereContains("name", locationToSearch);
                return query;
            }
        });
    }
